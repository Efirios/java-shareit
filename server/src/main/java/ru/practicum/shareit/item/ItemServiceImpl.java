...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto create(long userId, ItemDto itemDto) {
        ...
        return ItemMapper.toDto(itemRepository.save(ItemMapper.toItem(itemDto, owner, request)));
    }
    ...
    public CommentDto addComment(long userId, long itemId, CommentDto commentDto) {
        ...
        boolean allowed = bookingRepository.existsByItem_IdAndBooker_IdAndStatusAndEndLessThanEqual(
                itemId,
                userId,
